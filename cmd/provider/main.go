...
func main() {
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add AzAPI APIs to scheme")
	kingpin.FatalIfError(resolverapis.BuildScheme(apis.AddToSchemes), "Cannot register the AzAPI APIs with the API resolver's runtime scheme")
